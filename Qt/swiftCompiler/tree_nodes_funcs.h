...
{
    struct NExprList* list = (struct NExprList *)malloc(sizeof(struct NExprList));
...
{
  struct NImport* result = (struct NImport*)malloc(sizeof(struct NImport));
  result->name = func;
  return result;
}
...
{
    struct NStmtList* result = (struct NStmtList*)malloc(sizeof(struct NStmtList));
    result->first = first;
    result->last = first;
    return result;
}
...
{
    struct NFor* result = (struct NFor*)malloc(sizeof(struct NFor));
    result->name = operand;
    result->start = start;
    result->step = step;
    result->body = body;
...
{
    struct NWhile* result = (struct NWhile*)malloc(sizeof(struct NWhile));
...
{
    struct NSwitch* result = (struct NSwitch*)malloc(sizeof(struct NSwitch));
...
{
    struct NCaseList* result = (struct NCaseList*)malloc(sizeof(struct NCaseList));
...
{
  struct NRange* result = (struct NRange*)malloc(sizeof(struct NRange));
    result->start = start;
    result->end = end;
  return result;
}
...
{
  struct NCase* result = (struct NCase*)malloc(sizeof(struct NCase));
  if(label->name != NULL)
  {
...
struct NLabelCase* create_label_case(struct NExpr* condition,enum NSwitchCaseType type)
{
  struct NLabelCase* result = (struct NLabelCase*)malloc(sizeof(struct NLabelCase));
...
{
    struct NIf* result = (struct NIf*)malloc(sizeof(struct NIf));
    result->condition = condition;
...
{
    struct NIfList* result = (struct NIfList*)malloc(sizeof(struct NIfList));
    result->first = element;
    result->last = element;
    return result;
}
...
{
    struct NTblElem* result = (struct NTblElem*)malloc(sizeof(struct NTblElem));
    result->key = key;
    result->value = value;
    result->next = NULL;
    return result;
...
{
    struct NTable* result = (struct NTable*)malloc(sizeof(struct NTable));
    result->first = first;
    result->last = first;
    return result;
}
...
{
    struct NFunc* result = (struct NFunc*)malloc(sizeof(struct NFunc));
    result->name = NULL;
    result->vartype = type;
    result->args = args;
    result->body = body;
